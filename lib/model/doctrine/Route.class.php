    ...
    public static function buildRouteListCriteria(&$criteria, &$params_list, $is_module = false, $mid = 'm.id')
    {
        ...
        if (!$has_id)
        {
            if ($is_module)
            {
                ...
                self::buildConditionItem($conditions, $values, $joins, $params_list, 'Relative', array(array($m, 'r', 'elevation'), 'p.elevation'), 'pappr', 'parking');
            ...
            self::buildConditionItem($conditions, $values, $joins, $params_list, 'Relative', array(array($m, 'r', 'height_diff_down'), array($m, 'r', 'height_diff_up')), 'dudif', $join);
            ...
            self::buildConditionItem($conditions, $values, $joins, $params_list, 'Relative', array(array($m, 'r', 'height_diff_up'), array($m, 'r', 'difficulties_height')), 'rhappr', $join);
            self::buildConditionItem($conditions, $values, $joins, $params_list, 'Relative', array(array($m, 'r', 'elevation'), array($m, 'r', 'min_elevation')), 'rappr', $join);
