...
function loadRessources()
{
    ...
    $response->addJavascript($prototype_url . 'prototype.js?' . sfSVN::getHeadRevision('prototype.js'), 'head_first');
    ...
    $response->addJavascript($prototype_url . 'builder.js?' . sfSVN::getHeadRevision('builder.js'), 'first');
    $response->addJavascript($prototype_url . 'effects.js?' . sfSVN::getHeadRevision('effects.js'), 'head'); // needed by controls.js
    $response->addJavascript($prototype_url . 'dragdrop.js?' . sfSVN::getHeadRevision('dragdrop.js'), 'first'); // needed for sorting lists in modalboxes
    $response->addJavascript($prototype_url . 'controls.js?' . sfSVN::getHeadRevision('controls.js'), 'head'); // needed in head for autocomplete in modalboxes

    $response->addJavascript($static_base_url . '/sfModalBoxPlugin/js/modalbox.js?' . sfSVN::getHeadRevision('modalbox.js'), 'last');
    $response->addJavascript($static_base_url . '/static/js/submit.js?' . sfSVN::getHeadRevision('submit.js'), 'last');
    $response->addStylesheet($static_base_url . '/sfModalBoxPlugin/css/modalbox.css?' . sfSVN::getHeadRevision('modalbox.css'));
}
