...
function _filter_ratings_rock($document, $add_tooltips = false, $use_raw_value = false, $raw_value_prefix = null)
{
    ...
    $rock_free_raw_value = !empty($document[$rock_free_name]) ? $document[$rock_free_name] : $document->getRaw($rock_free_name);

    $rock_required_name = 'rock_required_rating';
    $rock_required_config = 'app_routes_rock_free_ratings';
    $rock_required_raw_value = !empty($document[$rock_required_name]) ? $document[$rock_required_name] : $document->getRaw($rock_required_name);
