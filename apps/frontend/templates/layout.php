...
<head>
    ...
    <!--[if lt IE 9]><script src="<?php echo $static_base_url. '/' . sfTimestamp::getTimestamp(array('/static/js/html5shiv.js','/static/js/autofocus.js')); ?>/static/js/html5shiv.js,/static/js/autofocus.js"></script><![endif]-->
    <?php
