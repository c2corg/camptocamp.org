...
$menu_see = array(
    '#' => ' ',
    url_for('@default?module=outings&action=list&orderby=date&order=desc') => __('outings'),
    ...
    url_for('@default?module=portals&action=list&orderby=wnam&order=asc') => __('portals'),
