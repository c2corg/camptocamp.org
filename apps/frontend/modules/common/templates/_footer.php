...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
            <p><?php echo __('Camptocamp.org version 5 revision %1%', array('%1%' => '<a href="https://trac.dev.camptocamp.org/changeset/' . sfConfig::get('app_versions_head'). '/camptocamp.org">' . date('Y-m-d H:i', sfConfig::get('app_versions_date')) . '</a>')) ?>
