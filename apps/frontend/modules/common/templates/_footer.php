...
<footer id="footer"<?php echo $class ?>>
    ...
    <?php endif ?>
        <div id="footer_cc_text">
            ...
            <p><?php echo __('Camptocamp.org version 5 revision %1%', array('%1%' => '<a href="https://github.com/c2corg/camptocamp.org/commit/' . sfConfig::get('app_versions_head'). '" class="footer_rev">' . date('YmdHi', sfConfig::get('app_versions_date')) . '</a>')) ?>
