...
<div class="article_contenu">
    <ul class="data">
        ...
        li(field_data_if_set($document, 'filename', '<input type="text" class="code" value="[img=', '|right]'.$document->get('name').'[/img]"/>'));
        li(field_data_if_set($document, 'filename', '<input type="text" class="code" value="[img=', ' '.$sf_params->get('id').' inline]'.$document->get('name').'[/img]"/>', 'forum_code'));
        ?>
    </ul>
</div>
