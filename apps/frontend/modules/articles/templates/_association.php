...
{
    $hide_no_associated_docs = 'display: none';
}
...
echo '<p class="default_text" style="'.$hide_no_associated_docs.'" id="'.$id_no_associated_docs.'">' . __('No associated document found') . '</p>';
