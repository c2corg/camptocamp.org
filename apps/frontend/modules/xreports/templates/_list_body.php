...
<td><?php echo (isset($item['rescue'])) ? _format_bool_data('', $item['rescue'], array('raw' => true, 'show_only_yes' => true, 'null_equals_no' => true)) : '' ?></td>
<td><?php echo $item['nb_impacted'] , '&nbsp;/&nbsp;' , $item['nb_participants'] ?></td>
