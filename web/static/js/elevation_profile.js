(function() {
  ...
  d3.xhr(window.c2cprofile.track, "application/xml", function(request) {
    ...
    var svg = d3.select("#elevation_profile_container_section_container").append("svg")
    ...
    if (!mobile) {
      ...
      // for eye-friendly transition NOT FOR MOBILE MAYBE
