/**
* This files contains links to files used by main app that should be included
* in c2corg API build. We include them in API and not in main app to avoid 
* multiple declaration of same object.
*
