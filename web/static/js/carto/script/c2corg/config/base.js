...
c2corg.base = {
    ...
    swisstopoOptions: {
        ...
        url: ['//wmts5.geo.admin.ch/', '//wmts6.geo.admin.ch/', '//wmts7.geo.admin.ch/',
              '//wmts8.geo.admin.ch/', '//wmts9.geo.admin.ch/'],
        style: "default",
        matrixSet: "21781",
        formatSuffix: 'jpeg',
        dimensions: ['TIME'],
        ...
        resolutions: [2500, 2250, 2000, 1750, 1500, 1250, 1000, 750, 650, 500, 250, 100, 50, 20, 10, 5, 2.5],
