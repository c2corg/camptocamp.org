...
{
    show_flags = new Array('ski', 'snow_ice', 'rock_mountain', 'hiking', 'ski_snow_ice', 'ski_snow_mountain_rock',
                           'ski_snow_mountain_rock_ice', 'snow_mountain_rock_ice', 'ski_snow_mountain_ice');
