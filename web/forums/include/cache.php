...
function generate_quickjump_cache($group_id = false)
{
	...
	while (list(, $group_id) = @each($groups))
	{
		...
		$output .= "\t\t\t\t".'<form class="qjump" method="get" action="viewforum.php">'."\n\t\t\t\t\t".'<div><label><?php echo $lang_common[\'Jump to\'] ?>'.' <select name="id" onchange="window.location=(\'viewforum.php?id=\'+this.options[this.selectedIndex].value)">'."\n";
