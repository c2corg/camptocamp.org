<?php
/**
 * $Id: symfony_head.php 2358 2007-11-17 16:17:43Z fvanderbiest $
 */
...
if (!$user->isConnected() && !is_null($cookie))
{
    ...
    if ($remember_key)
    {
        ...
        if ($dbuser->exists())
        {
            ...
            $user->signIn($private_data->getLoginName(), $private_data->getPassword(), true, true);
        }
    }
    else
    {
...
$i18n->setMessageSourceDir($dir, $user->getCulture());
...
$userAttributeHolder = $user->getAttributeHolder();
