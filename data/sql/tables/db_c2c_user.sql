...
BEGIN;
    ...
    INSERT INTO app_users_private_data (id, group_id, username, login_name, name_to_use, private_name, password, email, document_culture, language) VALUES (2, 1, 'c2c', 'c2c', 'username', 'Camptocamp-Association','a94a8fe5ccb19ba61c4c0873d391e987982fbbd3','board@camptocamp.org','fr', 'French');    INSERT INTO app_users_groups (user_id, group_id) VALUES (2, 1); -- superadmin
