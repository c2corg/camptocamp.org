...
CREATE OR REPLACE VIEW outings_i18n AS SELECT sa.id, sa.culture, sa.name, sa.search_name, sa.description, sa.participants, sa.weather, sa.hut_comments, sa.access_comments, sa.conditions, sa.conditions_levels, sa.timing FROM app_outings_i18n_archives sa WHERE sa.is_latest_version;
...
(
    INSERT INTO app_outings_i18n_archives (id, culture, name, search_name, description, participants, weather, hut_comments, access_comments, conditions, conditions_levels, timing, is_latest_version) VALUES (NEW.id, NEW.culture, NEW.name, NEW.search_name, NEW.description, NEW.participants, NEW.weather, NEW.hut_comments, NEW.access_comments, NEW.conditions, NEW.conditions_levels, NEW.timing, true)
);
